...
class AppTheme {
  ...
  static const Color dialogDark = backgroundDark;

  // Shadow colors - subtle for warm theme
  static const Color shadowLight = Color(0x0A000000);
  static const Color shadowDark = Color(0x1A000000);

  // Divider colors - minimal for clean design
  static const Color dividerLight = Color(0x0F2C2C2C);
  static const Color dividerDark = Color(0x1FF5F5F5);
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles - Inter Bold for impact
      ...
      // Headline styles - Inter SemiBold for hierarchy
      ...
      // Title styles - Inter Medium for structure
      ...
      // Body styles - Inter Regular for readability
